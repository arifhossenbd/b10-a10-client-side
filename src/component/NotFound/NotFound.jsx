...
const NotFound = ({ message, text, path }) => {
  return (
    <div className={`lg:absolute top-0 left-0 right-0 flex flex-col items-center h-screen justify-center text-center  bg-[url(/assets/1.jpg)] ${transition} text-stone-100 z-1`}>
